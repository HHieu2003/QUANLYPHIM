...
namespace GUI
{
    partial class frmDonHang
    {
        ...
        private Button btnThem, btnSua, btnXoa, btnLamMoi, btnTaiLai;

        private Label lblMaDonHang, lblMaKhachHang, lblNgayTao, lblTongTien;
        private TextBox txtMaDonHang, txtMaKhachHang, txtTongTien;
        ...
        private void InitializeComponent()
        {
            ...
            SetLabel(lblMaDonHang, "Mã đơn hàng:");
            pnlInput.Controls.Add(lblMaDonHang);
            SetTextBox(txtMaDonHang);
            pnlInput.Controls.Add(txtMaDonHang); y += yOffset;

            SetLabel(lblMaKhachHang, "Mã khách hàng:");
            pnlInput.Controls.Add(lblMaKhachHang);
            SetTextBox(txtMaKhachHang);
            pnlInput.Controls.Add(txtMaKhachHang); y += yOffset;

            SetLabel(lblNgayTao, "Ngày tạo:");
            pnlInput.Controls.Add(lblNgayTao);
            dtpNgayTao = new DateTimePicker
            {
            ...
            pnlInput.Controls.Add(dtpNgayTao); y += yOffset;

            SetLabel(lblTongTien, "Tổng tiền:");
            pnlInput.Controls.Add(lblTongTien);
            SetTextBox(txtTongTien);
            pnlInput.Controls.Add(txtTongTien); y += yOffset;
            ...
            SetButton(btnTaiLai, "Tải lại", Color.Gray, 390);
            ...
            dgvDonHang.Font = new Font("Segoe UI", 11F);
            dgvDonHang.DefaultCellStyle.Font = new Font("Segoe UI", 11F);
            dgvDonHang.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 12F, FontStyle.Bold);
            dgvDonHang.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(26, 166, 154);
            ...
            tblLayout.Controls.Add(dgvDonHang, 1, 0);
